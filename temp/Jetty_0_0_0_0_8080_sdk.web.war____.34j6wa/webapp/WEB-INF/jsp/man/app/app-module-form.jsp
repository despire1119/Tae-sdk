<c:set var="isLocalModule" value="true" />
...
<form:form action="/man/app/module/save/${appName}/${editMode}/" method="POST" commandName="moduleForm">
	...
	<input type="hidden" name="moduleFileType" value="2" />
