...
public class dc_StyleTagCallback implements TagCallback {
    private static final Log logger = LogFactory.getLog(dc_StyleTagCallback.class)
    ...
    private static final String TB_BLACK_CSS = "dc-tbml-filter-tbBlackCss.txt";
