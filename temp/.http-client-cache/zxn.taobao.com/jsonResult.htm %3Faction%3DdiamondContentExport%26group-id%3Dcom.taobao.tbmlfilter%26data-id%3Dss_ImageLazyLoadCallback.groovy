 ...
 */
public class ss_ImageLazyLoadCallback implements AttributeCallback {
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        try {
            ...
            logger.error("ss_ImageLazyLoadCallback,TBMLFilterException,",e)
        }
        if (value.startsWith("http://") && !value.equals(KS_PIC)) {
            ...
            if (attributes != null && "true".equals(attributes.get("shopsystemApp"))) {
                ...
                if (src2 != null) {
                    sb.append("\" ").append("data-cdn-reduce-traffic=\"").append(src2);
                }
