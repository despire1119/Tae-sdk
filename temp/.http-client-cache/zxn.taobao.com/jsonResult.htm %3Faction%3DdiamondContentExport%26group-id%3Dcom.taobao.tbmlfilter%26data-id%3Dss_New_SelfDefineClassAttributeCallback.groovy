...
public class ss_New_SelfDefineClassAttributeCallback implements AttributeCallback {
    private static final Log logger = LogFactory.getLog("TBMLFilter");
    private static final String TB_BLACK_CLASS = "ss-new-selfDefine-blackClass.txt"
    private static final String TB_WHITE_CLASS = "ss-new-selfDefine-whiteClass.txt"
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        try {
            ...
            logger.error("ss_New_SelfDefineClassAttributeCallback,TBMLFilterException,",e)
        }
        return value
    }
}
