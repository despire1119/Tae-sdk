...
public class ds_SDK_StyleTagCallback implements TagCallback {
    private static final Log logger = LogFactory.getLog(ds_SDK_StyleTagCallback.class)
    ...
    private static final String TB_BLACK_CSS = "ds-sdk-blackCss.txt";
