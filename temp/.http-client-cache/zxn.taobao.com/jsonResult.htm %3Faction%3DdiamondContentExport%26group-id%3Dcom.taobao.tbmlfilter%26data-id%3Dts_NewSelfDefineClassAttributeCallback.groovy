...
public class ts_NewSelfDefineClassAttributeCallback implements AttributeCallback {

    private static final Log logger = LogFactory.getLog("TBMLFilter");
    private static final String TB_BLACK_CLASS = "ts-new-selfDefine-blackClass.txt"
    private static final String TB_WHITE_CLASS = "ts-new-selfDefine-whiteClass.txt"
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        try {
            ...
            logger.error("ts_NewSelfDefineClassAttributeCallback,TBMLFilterException,",e)
        }
        return value
    }
