...
public class ss_New_OldSDKClassAttributeCallback implements AttributeCallback {
    private static final Log logger = LogFactory.getLog("TBMLFilter");

    private static final String TB_BLACK_CLASS = "ss-new-oldSdkBlackClass.txt";
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        try {
            ...
            logger.error("ss_New_OldSDKClassAttributeCallback,TBMLFilterException,",e)
        }
        return value
    }
}
