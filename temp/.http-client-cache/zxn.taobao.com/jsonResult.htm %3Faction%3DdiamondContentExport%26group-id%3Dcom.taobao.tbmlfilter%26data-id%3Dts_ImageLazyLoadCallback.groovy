 ...
 */
public class ts_ImageLazyLoadCallback implements AttributeCallback {

    private static final Log logger = LogFactory.getLog(ts_ImageLazyLoadCallback.class);
    private static final String TB_BLACK_URL = "ts-tbml-filter-tbBlackUrl.txt"
