...
public class sc_StyleTagCallback implements TagCallback {
    private static final Log logger = LogFactory.getLog(sc_StyleTagCallback.class)
    ...
    public String filterChildText(TBMLFilter filter, String childrenText) {
        try {
            ...
            logger.error("sc_StyleTagCallback,TBMLFilterException,",e)
        }
        return childrenText
    }
