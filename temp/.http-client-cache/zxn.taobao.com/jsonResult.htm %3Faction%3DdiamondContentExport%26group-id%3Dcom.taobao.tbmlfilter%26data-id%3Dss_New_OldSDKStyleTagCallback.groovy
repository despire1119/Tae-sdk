...
public class ss_New_OldSDKStyleTagCallback implements TagCallback {
    private static final Log logger = LogFactory.getLog(ss_New_OldSDKStyleTagCallback.class)
    ...
    public String filterChildText(TBMLFilter filter, String childrenText) {
        try {
            ...
            logger.error("ss_New_OldSDKStyleTagCallback,TBMLFilterException,",e)
        }
        return childrenText
    }

    private static final String TB_BLACK_CSS = "ss-new-oldSdkBlackCss.txt";
