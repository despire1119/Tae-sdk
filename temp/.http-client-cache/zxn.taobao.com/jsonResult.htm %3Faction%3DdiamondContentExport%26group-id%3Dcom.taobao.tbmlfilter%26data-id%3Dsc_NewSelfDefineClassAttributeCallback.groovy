...
public class sc_NewSelfDefineClassAttributeCallback implements AttributeCallback {
    private static final Log logger = LogFactory.getLog("TBMLFilter");

    private static final String TB_BLACK_CLASS = "sc-new-selfDefine-blackClass.txt"
    private static final String TB_WHITE_CLASS = "sc-new-selfDefine-whiteClass.txt"
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        try {
            ...
            logger.error("sc_NewSelfDefineClassAttributeCallback,TBMLFilterException,",e)
        }
        return value
    }
}
