...
public class ss_Old_SDKStyleTagCallback implements TagCallback {
    private static final Log logger = LogFactory.getLog(ss_Old_SDKStyleTagCallback.class);
    ...
    public String filterChildText(TBMLFilter filter, String childrenText) {
        try {
            ...
            logger.error("ss_Old_SDKStyleTagCallback,TBMLFilterException,",e)
        }
        return childrenText
    }

    private static final String TB_BLACK_CSS = "ss-old-sdkBlackCss.txt";
