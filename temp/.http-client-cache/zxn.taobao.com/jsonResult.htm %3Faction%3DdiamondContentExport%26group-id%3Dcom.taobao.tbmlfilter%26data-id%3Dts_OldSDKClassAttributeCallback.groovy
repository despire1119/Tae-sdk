...
public class ts_OldSDKClassAttributeCallback implements AttributeCallback {
    private final static Log logger = LogFactory.getLog("TBMLFilter");

    private static final String TB_BLACK_CLASS = "ts-sdk-old-blackClass.txt"
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        /*try {
            ...
            if (cacheBlack == null || blackPattern == null || !cacheBlack.equals(blackClass)) {
                ...
                blackPattern = ClassUtil_22.getClassPattern(blackClass)
            }
            return ClassUtil_22.filter(blackPattern, value, attributes)
        } catch (e) {
            logger.error(e)
        }*/
        return value
