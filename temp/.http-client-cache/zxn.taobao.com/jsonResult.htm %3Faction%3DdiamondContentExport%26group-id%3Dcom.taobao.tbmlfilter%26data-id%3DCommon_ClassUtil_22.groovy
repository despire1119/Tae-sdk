...
public class Common_ClassUtil_22 {
    ...
    public static String filter(Pattern blackPattern, List<String> whiteList, String value, Map<String, String> attributes) {
        if (!StringUtils.isBlank(value) && blackPattern != null) {
            value = value + " "
            ...
            if(value.contains("&#")){
                logger.error("classUtil.contains.specialChar:"+value)
    ...
    private static String filterClass(Pattern blackPattern, String value) {
        ...
        return replaceAllIgnoreCase(value, blackPattern, "-_-");
    }
