...
public class ss_ClassAttributeCallback implements AttributeCallback {

    private static final Log logger = LogFactory.getLog("TBMLFilter");
    private static final String TB_BLACK_CLASS = "ss-tbml-filter-tbBlackClass.txt"
    ...
    public String filterValue(TBMLFilter filter, String value, Map<String, String> attributes) {
        try {
            ...
            logger.error("ss_ClassAttributeCallback,TBMLFilterException,",e)
        }
        return value
    }
}
